    ...
    async def on_message(self, message):
      ...
      try:
        ...
        with open('ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
          ...
          elif message.content == Aloa or message.content == "<@!1012627088232165376>":
            ...
            if str(message.channel.id) in randi["ids"]:
              ...
              embed.set_author(name="Aloa", icon_url=self.client.user.display_avatar.url)
