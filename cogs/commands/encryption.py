...
class Encryption(commands.Cog):
  ...
  async def decode_base32(self, ctx, *, txtinput: str):
    ...
    try:
      await self.encryptout(ctx, "base32 -> Text",
                            base64.b32decode(txtinput.encode("UTF-8")))
    except Exception:
  ...
  async def encode_base64(self, ctx, *, txtinput: commands.clean_content):
    ...
    await self.encryptout(ctx, "Text -> base64",
                          base64.urlsafe_b64encode(txtinput.encode("UTF-8")))
  ...
  async def encode_rot13(self, ctx, *, txtinput: commands.clean_content):
    """ Encode in rot13 """
    await self.encryptout(ctx, "Text -> rot13",
                          codecs.decode(txtinput, "rot_13"))

  @decode.command(name="rot13", aliases=["r13"])
  async def decode_rot13(self, ctx, *, txtinput: str):
    """ Decode in rot13 """
    try:
      await self.encryptout(ctx, "rot13 -> Text",
                            codecs.decode(txtinput, "rot_13"))
    except Exception:
  ...
  async def encode_hex(self, ctx, *, txtinput: commands.clean_content):
    """ Encode in hex """
    await self.encryptout(ctx, "Text -> hex",
  ...
  async def decode_hex(self, ctx, *, txtinput: str):
    """ Decode in hex """
    try:
      await self.encryptout(ctx, "hex -> Text",
                            binascii.unhexlify(txtinput.encode("UTF-8")))
    except Exception:
  ...
  async def decode_base85(self, ctx, *, txtinput: str):
    """ Decode in base85 """
    try:
      await self.encryptout(ctx, "base85 -> Text",
                            base64.b85decode(txtinput.encode("UTF-8")))
    except Exception:
  ...
  async def encode_ascii85(self, ctx, *, txtinput: commands.clean_content):
    """ Encode in ASCII85 """
    await self.encryptout(ctx, "Text -> ASCII85",
  ...
  async def decode_ascii85(self, ctx, *, txtinput: str):
    """ Decode in ASCII85 """
    try:
      await self.encryptout(ctx, "ASCII85 -> Text",
                            base64.a85decode(txtinput.encode("UTF-8")))
    except Exception:
