...
class Moderation(commands.Cog):
    ...
    async def unlockall(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:tick:1096303195480932372> | Unlocking all channels in few seconds .",
    ...
    async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:tick:1096303195480932372> | Locking all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
    ...
    async def hackban(self, ctx, userid, *, reason=None):
        ...
        try:
            ...
            await ctx.reply(embed=discord.Embed(
                description=
                f"<:tick:1096303195480932372> | Successfully hackbanned {userid} for {reason}",
                color=0x2f3136))
        except:
            await ctx.reply(embed=discord.Embed(
    ...
    async def _hideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:tick:1096303195480932372> | Hiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | Unhiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
    ...
    async def _hide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | Succefully Hidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _unhide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | Succefully Unhidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
    ...
    async def _softban(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | Sucessfully soft-banned {member}.",
            timestamp=ctx.message.created_at)
    ...
    async def purge(self, ctx, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)-1} message(s)**"
        )
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
        )
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
        )
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
        )
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
        )
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:tick:1096303195480932372> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
        )
        ...
        if tame == -1:
            ...
            if till.lower() == "d":
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:tick:1096303195480932372> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "m":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:tick:1096303195480932372> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "s":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:tick:1096303195480932372> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "h":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:tick:1096303195480932372> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
        try:
        ...
        if member.is_timed_out():
            try:
                ...
                hacker5 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:tick:1096303195480932372> | Successfully Unmuted {member.name}",
                    timestamp=ctx.message.created_at)
    ...
    async def _kick(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or member == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:tick:1096303195480932372> | {member.display_name} has been kicked from this guild, for: {reason}",
                timestamp=ctx.message.created_at)
    ...
    async def _warn(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | {member.display_name} has been warned for: {reason}",
            timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _ban(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x00FFE4,
                description=
                f"<:tick:1096303195480932372> | {member.display_name} has been successfully banned for the reason: `{reason}`",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _unban(self, ctx: commands.Context, id: int):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | {user.name} has been successfully unbanned",
            timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | {channel.name} has been successfully cloned",
            timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def changenickname(self, ctx: commands.Context,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:tick:1096303195480932372> | Successfully changed nickname of {member.name}",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.send(embed=discord.Embed(
            description=
            f"<:tick:1096303195480932372> | Successfully Removed {total_reactions}.",
            color=0x2f3136))
