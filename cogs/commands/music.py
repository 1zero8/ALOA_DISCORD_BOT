...
#<:volume_down:1056039813712707654>
  ...
  @discord.ui.button(emoji="<:Aloa_rewind:1060035624314339349>",
                     style=discord.ButtonStyle.grey,
                     row=0)
  async def seek_button(self, interaction: discord.Interaction,
    ...
    if player.is_playing:
      ...
      hacker2 = discord.Embed(
        description="<:error:1018174714750976030> | I am not playing anything.",
        color=0x2f3136)
      return await interaction.response.send_message(embed=hacker2,
                                                     ephemeral=True)
  ...
  async def stop_button(self, interaction: discord.Interaction,
    ...
    if player.is_playing:
      ...
      await player.stop()
      hacker1 = discord.Embed(
        description=f"<:tick:1096303195480932372> | Destroyed the player.",
        color=0x2f3136)
      return await interaction.response.send_message(embed=hacker1,
                                                     ephemeral=True)
    else:
  ...
  async def skip_button(self, interaction: discord.Interaction,
    ...
    if player.is_playing:
      ...
      hacker1 = discord.Embed(
        description=
        "<:tick:1096303195480932372> | Successfully Skipped the track .",
        color=0x2f3136)
      return await interaction.response.send_message(embed=hacker1,
                                                     ephemeral=True)
    else:
  ...
  async def vol_button(self, interaction: discord.Interaction,
    ...
    if player.is_playing:
      ...
      hacker1 = discord.Embed(
        description=
        "<:tick:1096303195480932372> | Successfully changed player volume to : `100`",
        color=0x2f3136)
      return await interaction.response.send_message(embed=hacker1,
                                                     ephemeral=True)
    else:
...
class Music(commands.Cog):
  ...
  async def play(self, ctx: commands.Context, *, search: str):
    ...
    if not ctx.voice_client:
      ...
      await ctx.send(
        f"<:tick:1096303195480932372> | Successfully Connected To {ctx.author.voice.channel.mention}"
      )
    else:
    ...
    if 'https://open.spotify.com' in str(search):
      ...
      if vc.queue.is_empty and not vc.is_playing():
        ...
        mbed = discord.Embed(
          color=0x2f3136,
          description=
          f"<a:jk_playing:1096339286212751381> [{track.title}](https://dsc.gg/aloa-support)"
        )
        # mbed.add_field(name="<a:jk_playing:1096339286212751381> ", value=f"[{track.title}](https://dsc.gg/aloa-support)")
        # mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{cthttps://dsc.gg/aloa-support.author.mention}")
        mbed.add_field(name="<:jk_stage:1096339398968221756> Song By",
                       value=f"`{track.author}`")
        mbed.add_field(name="<a:jk_time:1096339502953406544> Duration",
        ...
        embed = discord.Embed(
          description=
          f'[{track}](https://dsc.gg/aloa-support) Added To The Queue',
          color=0x2f3136)
      ...
      if vc.queue.is_empty and not vc.is_playing():
        ...
        mbed = discord.Embed(
          color=0x2f3136,
          description=
          f"<a:jk_playing:1096339286212751381> [{track1}](https://dsc.gg/aloa-support)"
        )
        mbed.add_field(name="Song Url", value=search)
        # mbed.add_field(name="<a:jk_playing:1096339286212751381> ", value=f"[{track1}](https://dsc.gg/aloa-support)")
        mbed.set_author(name="NOW PLAYING", icon_url=f"{ctx.author.avatar}")
        mbed.set_thumbnail(url=self.bot.user.display_avatar.url)
        mbed.set_footer(text=f"Requested By {ctx.author}",
                        icon_url=f"{ctx.author.avatar}")
        ...
        embed = discord.Embed(
          description=
          f'[{track1}](https://dsc.gg/aloa-support) Added To The Queue',
          color=0x2f3136)
      ...
      if vc.queue.is_empty and not vc.is_playing():
        ...
        mbed = discord.Embed(
          color=0x2f3136,
          description=
          f"<a:jk_playing:1096339286212751381> [{track2.title}](https://dsc.gg/aloa-support)"
        )
        #mbed.add_field(name="<a:jk_playing:1096339286212751381> ", value=f"[{track2.title}](https://dsc.gg/aloa-support)")
        ...
        embed = discord.Embed(
          description=
          f'[{track2}](https://dsc.gg/aloa-support) Added To The Queue',
          color=0x2f3136)
    ...
    if not player.queue.is_empty:
      ...
      if hasattr(new_song, 'thumb'):
        mbed = discord.Embed(
          color=0x2f3136,
          description=
          f"<a:jk_playing:1096339286212751381> [{new_song.title}](https://dsc.gg/aloa-support)"
        )
        #mbed.add_field(name="<a:jk_playing:1096339286212751381> ", value=f"[{new_song.title}](https://dsc.gg/aloa-support)")
        #mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{ctx.author.mention}")
        mbed.add_field(name="<:jk_stage:1096339398968221756> Song By",
        ...
        #mbed.add_field(name="<a:jk_playing:1096339286212751381> ", value=f"[{new_song.title}](https://dsc.gg/aloa-support)")
        mbed.add_field(name="<:jk_users:1096340319353704520> Requested By",
  ...
  async def stop_command(self, ctx: commands.Context):
    ...
    if player.is_playing:
      ...
      await player.stop()
      hacker1 = discord.Embed(
        description=f"<:GreenTick:1018174649198202990> | Destroyed the player.",
        color=0x2f3136)
  ...
  async def boost_command(self, ctx: commands.Context):
    ...
    if vc is None:
      ...
      return await ctx.reply(embed=hacker)
    bands = [(0, 0.2), (1, 0.15), (2, 0.1), (3, 0.05), (4, 0.0), (5, -0.05),
  ...
  async def move_to(self, ctx, channel: discord.VoiceChannel) -> None:
    ...
    hacker4 = discord.Embed(
      description=f"Moving to voice channel:: {channel.id} .", color=0x2f3136)
  ...
  async def volume(self, ctx, volume):
    ...
    if ((not volume.isdigit()) or (int(volume)) < 0 or (int(volume) > 500)):
      hacker = discord.Embed(
        description="<:error:1018174714750976030> | Volume Must Be 0 To 500 .",
        color=0x2f3136)
      hacker.set_footer(text=f"Requested By {ctx.author}",
                        icon_url=f"{ctx.author.avatar}")
      #hacker.set_thumbnail(url = f"{ctx.author.avatar}")
  ...
  async def playing(self, ctx):
    ...
    em = discord.Embed(
      description=f"[{vc.track}](https://dsc.gg/aloa-support)", color=0x2f3136)

    em.add_field(name="<:jk_stage:1096339398968221756> Song By",
                 value=f"`{vc.track.author}`")
    em.add_field(name="<a:jk_time:1096339502953406544> Duration",
  ...
  async def _queue(self, ctx):
    ...
    if vc.queue.is_empty:
      hacker3 = discord.Embed(
        description=f"<:error:1018174714750976030> | No songs in queue .",
        color=0x2f3136)
    ...
    for song in copy:
      ...
      hacker4.add_field(name=f"Position : {count}",
                        value=f"[{song.title}](https://dsc.gg/aloa-support)")
