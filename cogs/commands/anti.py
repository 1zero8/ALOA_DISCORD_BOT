...
from core import Cog, Aloa, Context
import discord
...
class Security(Cog):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      if data == "on":
        embed = discord.Embed(
          title="Aloa",
          description=
          f"**{ctx.guild.name} Security Settings **<:security:1075713699433685022>\nOhh uh! looks like your server has already enabled security\n\nCurrent Status: <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n\n> To disable use `antinuke disable`",
          color=0x2f3136)
        ...
        embed2 = discord.Embed(
          title="Aloa",
          description=
          f"**{ctx.guild.name} Security Settings** <:security:1075713699433685022>\nAlso move my role to top of roles for me to work properly.\n\nPunishments:\n\n**Anti Bot:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Ban:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Kick:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Prune:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130> \n**Anti Channel Create/Delete/Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Role Create/Delete/Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Webhook Create:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Emoji Create/Delete/Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Guild Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Community Spam:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Integration Create:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Everyone/Here/Role Mention:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>",
          color=0x2f3136)
        embed2.add_field(
          name="Other Settings",
          value=
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      if data == "off":
        emb = discord.Embed(
          title="Aloa",
          description=
          f"**{ctx.guild.name} Security Settings **<:security:1075713699433685022>\nOhh NO! looks like your server has already disabled security\n\nCurrent Status: <:antinuke_nope:1077493928460308490><:n_antinuke_yes:1077494960699494400>\n\n> To enable use `antinuke enable`",
          color=0x2f3136)
  ...
  async def antinuke_show(self, ctx: Context):
    ...
    if data == "off":
      ...
      embed2 = discord.Embed(
        title="Aloa",
        description=
        f"**{ctx.guild.name} Security Settings** <:role:1072490444879056998>\nPunishments:\n**Anti Bot:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Ban:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Kick:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Prune:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Channel Create/Delete/Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Role Create/Delete/Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Webhook Create:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Emoji Create/Delete/Update:** <:antinuke_yes:1077493932759470130>\n**Anti Guild Update:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Community Spam:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Integration Create:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Everyone/Here/Role Mention:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Anti Vanity Steal:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>\n**Whitelisted Role:** <@&{wlrole}>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:n_antinuke_nope:1077493923896889384><:antinuke_yes:1077493932759470130>",
        color=0x2f3136)
      embed2.add_field(
        name="Other Settings",
        value=
  ...
  async def _recover(self, ctx: Context):
    ...
    hacker5 = discord.Embed(
      title="Aloa",
      description=
      "<:tick:1076042204310679562> | Successfully Deleted All Channels With Name Of `rules` and `moderator-only`",
      color=0x2f3136)
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      if kickOrBan == "kick":
        ...
        hacker = discord.Embed(
          title="Aloa",
          description=
          f"<:tick:1076042204310679562> | Successfully Changed Punishment To: **{kickOrBan}** For {ctx.guild.name}",
          color=0x2f3136)
  ...
  async def _channelclean(self, ctx: Context, channeltodelete: str):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      hacker1 = discord.Embed(
        title="Aloa",
        description=
        f"<:tick:1076042204310679562> | Successfully Deleted All Channels With The Name Of {channeltodelete}",
        color=0x2f3136)
      await ctx.reply(embed=hacker1, mention_author=False)
    elif ctx.author.id == 735003878424313908:
      for channel in ctx.message.guild.channels:
        if channel.name == channeltodelete:
          try:
            await channel.delete()
  ...
  async def _roleclean(self, ctx: Context, roletodelete: str):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      hacker = discord.Embed(
        title="Aloa",
        description=
        f"<:tick:1076042204310679562> | Successfully Deleted All Roles With The Name Of {roletodelete}",
        color=0x2f3136)
      await ctx.reply(embed=hacker, mention_author=False)
    elif ctx.author.id == 735003878424313908:
      for role in ctx.message.guild.roles:
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      if len(wled) == 15:
        hacker = discord.Embed(
          title="Aloa",
          description=
          f"<:cross:1077478135794245743> This server have already maximum number of whitelisted users (15)\nRemove one to add another :)",
          color=0x2f3136)
        await ctx.reply(embed=hacker, mention_author=False)
      else:
        if str(user.id) in wled:
          hacker1 = discord.Embed(
            title="Aloa",
            description=
            f"<:cross:1077478135794245743> That user is already in my whitelist.",
            color=0x2f3136)
          await ctx.reply(embed=hacker1, mention_author=False)
        else:
          ...
          hacker4 = discord.Embed(
            ...
            title="Aloa",
            description=
            f"<:tick:1076042204310679562> | Successfully Whitelisted {user.mention} For {ctx.guild.name}"
          )
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      if str(user.id) in wled:
        ...
        hacker = discord.Embed(
          ...
          title="Aloa",
          description=
          f"<:tick:1076042204310679562> | Successfully Unwhitelisted {user.mention} For {ctx.guild.name}"
        )
        await ctx.reply(embed=hacker, mention_author=False)
      else:
        hacker2 = discord.Embed(
          ...
          title="Aloa",
          description=
          "<:cross:1077478135794245743> | That user is not in my whitelist.")
        await ctx.reply(embed=hacker2, mention_author=False)
    else:
      hacker5 = discord.Embed(
        description=
  ...
  async def whitelist_show(self, ctx):
    ...
    if len(wled) == 0:
      hacker = discord.Embed(
        ...
        title="Aloa",
        description=
        f"<:cross:1077478135794245743> | There aren\'t any whitelised users for this server"
      )
      await ctx.reply(embed=hacker, mention_author=False)
    else:
      entries = [
  ...
  async def wl_reset(self, ctx: Context):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      hacker = discord.Embed(
        ...
        title="Aloa",
        description=
        f"<:tick:1076042204310679562> | Successfully Cleared Whitelist Database For **{ctx.guild.name}**"
      )
      await ctx.reply(embed=hacker, mention_author=False)
    else:
      hacker5 = discord.Embed(
  ...
  async def whitelist_role(self, ctx, role: discord.Role):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      hacker4 = discord.Embed(
        ...
        title="Aloa",
        description=
        f"<:tick:1076042204310679562> | {role.mention} Has Been Added To Whitelisted Role For {ctx.guild.name}"
      )
      await ctx.reply(embed=hacker4, mention_author=False)
