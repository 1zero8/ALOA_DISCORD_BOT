...
async def Krypton_stats():
  while True:
    ...
    sv_ch = client.get_channel(1094887988149882940)
    users_ch = client.get_channel(1094887988149882940)
...
@tree.command(name="embed", description="Create A Embed Using Aloa")
...
async def on_command_completion(context: Context) -> None:
  ...
  hacker = client.get_channel(1094887988149882940)
  if context.guild is not None:
    try:
      ...
      embed.add_field(
        ...
        inline=False)
      embed.add_field(
        name="<a:im_arrowr:1038029121881636884> Command Executed In Channel :",
        value=
        f"{context.channel.name}  | ID: [{context.channel.id}](https://discord.com/channel/{context.channel.id})",
        inline=False)
      embed.set_footer(text="Powered By Aloa",
    ...
    try:
      ...
      embed1.add_field(
        ...
        f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
        inline=False)
      embed1.set_footer(text="Powered By Aloa",
                        icon_url=client.user.display_avatar.url)
